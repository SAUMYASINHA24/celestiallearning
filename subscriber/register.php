<?php
    ...
    {
        echo $twig->render('subscriber/register.html.twig');
    }
    else
    {
        $errors = array();
        ...
        else
        {
            ...
            if($result1 || $result2)
            {
                ...
                if($row_count1>0)
                {
                    ...
                    echo $twig->render('subscriber/register.html.twig', array('errors' => $errors));    
                }
                ...
                {    
                    $flag = sendActivationMail($emailid, $username); 
                    if($flag==1)
                    {
                        ...
                        $status = "Inactive";  
                        $stmt->execute();        
                        echo $twig->render('subscriber/register.html.twig', ['activation_link' => "You have registered and the activation mail is sent to your email. Click the activation link to activate you account."]);                                         
