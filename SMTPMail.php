<?php
    ...
    function sendActivationMail($email, $username){
        ...
        try {
            ...
            $mail->Username   = 'saumyasinhatest@gmail.com';                     // SMTP username
            $mail->Password   = 'Jaimatadi@123';                               // SMTP password
    ...
    function sendForgetPasswordLink($email){
        ...
        try {
            ...
            $stmt->execute();
            //-------------------------
            $actual_link = "http://www.celestiallearning.com/forgetpasswordverify.php?t=" . $hash;
            //Recipients
            $mail->setFrom('noreply@celestiallearning.com', 'Celestial Learning');
            $mail->addAddress($email, $username);     // Add a recipient
            $body  = "<h2>Hello " . $username . "</h2>";
